    ...
    <div class="hidden lg:flex lg:w-1/2 relative flex-col justify-center items-center px-12 xl:px-24 overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-5xl xl:text-7xl font-extrabold text-white leading-[1.2] mb-6">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-500">with precision.</span>
            </h1>
            
            <p class="text-xl text-gray-400 max-w-lg mb-12 leading-relaxed">
                Unlock the power of high-speed geographic data APIs. Join thousands of developers building the next generation of global applications.
            </p>
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-4 group">
                    ...
                    <div>
                        <h3 class="text-white font-bold">Ultra-fast Responses</h3>
                        <p class="text-gray-500 text-sm">Sub-50ms latency for global lookups.</p>
                    </div>
                </div>
                <div class="flex items-center gap-4 group">
                    <div class="w-12 h-12 rounded-2xl bg-amber-500/10 flex items-center justify-center border border-amber-500/20 group-hover:border-amber-500/50 transition-all">
                    ...
                    <div>
                        <h3 class="text-white font-bold">Enterprise Analytics</h3>
                        <p class="text-gray-500 text-sm">99.99% Uptime with detailed API logging.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-full lg:w-1/2 flex justify-center p-6 sm:p-12 relative glass-panel h-screen overflow-y-auto">
        <div class="max-w-md w-full my-auto">
            ...
            <div class="mb-6 hidden lg:block">
                <h2 class="text-4xl font-extrabold text-white mb-2 leading-snug">Login</h2>
                <p class="text-gray-400 text-sm">Please enter your credentials to access your dashboard.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                ...
                <div x-data="{ show: false }">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="{{ route('password.request') }}" class="text-xs font-bold text-amber-500 hover:text-amber-400 transition-colors">Forgot Password?</a>
                    </div>
                    <div class="relative">
                ...
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox" class="h-4 w-4 text-amber-600 focus:ring-amber-500 bg-white/5 border-white/10 rounded cursor-pointer">
                    <label for="remember" class="ml-3 block text-sm text-gray-500 cursor-pointer hover:text-gray-400 transition-colors">
                        Keep me logged in
                    </label>
                </div>
            ...
            <div class="mt-8">
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="font-bold text-amber-500 hover:text-amber-400 ml-1 transition-colors">Create Account</a>
                </p>
            </div>
