...
@section('content')
<div class="max-w-6xl mx-auto" x-data="{ activeTab: 'faqs' }">
    <!-- Header Section -->
    <div class="mb-10 text-center">
        <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">How can we help you?</h2>
        <p class="mt-4 text-lg text-gray-500 dark:text-gray-400">Browse FAQs, view your history, or submit a new ticket.</p>
    </div>
    ...
    <!-- FAQs Tab -->
    <template x-if="activeTab === 'faqs'">
        <div x-transition:enter="transition ease-out duration-300 transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="space-y-4">
    ...
    <template x-if="activeTab === 'history'">
        <div x-transition:enter="transition ease-out duration-300 transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="space-y-6">
            ...
            @empty
                <div class="text-center py-20 bg-white dark:bg-richdark-surface rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/5">
                    ...
                    <p class="text-gray-400 text-sm">Submit your first support request using the "Submit New Ticket" tab.</p>
                </div>
            @endforelse
        </div>
    </template>
