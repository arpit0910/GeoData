...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('countries.index') }}" class="text-amber-600 hover:text-amber-800 text-sm font-medium flex items-center bg-white px-3 py-1.5 rounded border border-gray-200 shadow-sm">
        ...
        <form action="{{ route('countries.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="col-span-1 md:col-span-2 lg:col-span-3">
                    ...
                    <input type="text" name="name" id="name" required value="{{ old('name') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="Enter country name">
                ...
                <div>
                    ...
                    <input type="text" name="iso2" id="iso2" maxlength="2" value="{{ old('iso2') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. IN">
                ...
                <div>
                    ...
                    <input type="text" name="iso3" id="iso3" maxlength="3" value="{{ old('iso3') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. IND">
                ...
                <div>
                    ...
                    <input type="text" name="numeric_code" id="numeric_code" maxlength="3" value="{{ old('numeric_code') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 356">
                ...
                <div>
                    ...
                    <input type="text" name="phonecode" id="phonecode" value="{{ old('phonecode') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 91">
                ...
                <div>
                    ...
                    <input type="text" name="tld" id="tld" value="{{ old('tld') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. .in">
                ...
                <div>
                    ...
                    <input type="text" name="capital" id="capital" value="{{ old('capital') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. New Delhi">
                ...
                <div>
                    ...
                    <input type="text" name="native" id="native" value="{{ old('native') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Bharat">
                    @error('native')<span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                </div>

                <div>
                    <label for="nationality" class="block text-sm font-medium text-gray-700">Nationality</label>
                    <input type="text" name="nationality" id="nationality" value="{{ old('nationality') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Indian">
                ...
                <div>
                    ...
                    <select name="region_id" id="region_id" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border">
                        <option value="" selected disbaled>Select a Region</option>
                        @foreach($regions as $r)
                            <option value="{{ $r->id }}" {{ old('region_id') == $r->id ? 'selected' : '' }}>{{ $r->name }} ({{ $r->id }})</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="subregion_id" id="subregion_id" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border">
                        <option value="" selected disbaled>Select a Sub Region</option>
                ...
                <div>
                    ...
                    <input type="number" step="any" name="area_sq_km" id="area_sq_km" value="{{ old('area_sq_km') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 3287263.00">
                ...
                <div>
                    ...
                    <input type="text" name="currency" id="currency" value="{{ old('currency') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. INR">
                ...
                <div>
                    ...
                    <input type="text" name="currency_name" id="currency_name" value="{{ old('currency_name') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Indian Rupee">
                ...
                <div>
                    ...
                    <input type="text" name="currency_symbol" id="currency_symbol" value="{{ old('currency_symbol') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. ₹">
                ...
                <div>
                    ...
                    <input type="text" name="emoji" id="emoji" value="{{ old('emoji') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 🇮🇳">
                ...
                <div>
                    ...
                    <input type="text" name="emojiU" id="emojiU" value="{{ old('emojiU') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. U+1F1EE U+1F1F3">
                ...
                <div>
                    ...
                    <input type="text" name="postal_code_format" id="postal_code_format" value="{{ old('postal_code_format') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. ######">
                ...
                <div>
                    ...
                    <input type="text" name="postal_code_regex" id="postal_code_regex" value="{{ old('postal_code_regex') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. ^\d{6}$">
                ...
                <div>
                    ...
                    <input type="text" name="wiki_data_id" id="wiki_data_id" value="{{ old('wiki_data_id') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Q668">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="population" id="population" value="{{ old('population') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="Enter population">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="gdp" id="gdp" value="{{ old('gdp') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="Enter GDP">
                ...
                <div>
                    ...
                    <input type="number" name="max_mobile_digits" id="max_mobile_digits" value="{{ old('max_mobile_digits') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 10">
                ...
                <div>
                    ...
                    <input type="text" name="international_prefix" id="international_prefix" value="{{ old('international_prefix') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 00">
                ...
                <div>
                    ...
                    <input type="text" name="trunk_prefix" id="trunk_prefix" value="{{ old('trunk_prefix') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 0">
                ...
                <div>
                    ...
                    <input type="text" name="income_level" id="income_level" value="{{ old('income_level') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. High income">
                ...
                <div>
                    ...
                    <select name="driving_side" id="driving_side" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border">
                        <option value="" selected>Select Driving Side</option>
                ...
                <div>
                    ...
                    <input type="text" name="measurement_system" id="measurement_system" value="{{ old('measurement_system') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Metric">
                ...
                <div>
                    ...
                    <input type="text" name="tax_system" id="tax_system" value="{{ old('tax_system') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. VAT">
                ...
                <div>
                    ...
                    <input type="text" name="standard_tax_rate" id="standard_tax_rate" value="{{ old('standard_tax_rate') }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. 10%">
                ...
                <div class="col-span-1 lg:col-span-3">
                    ...
                    <textarea name="timezones" id="timezones" rows="3" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="Enter timezone data in JSON format">{{ old('timezones') }}</textarea>
            ...
            <div class="mt-8 border-t border-gray-200 pt-5">
                <div class="flex justify-end">
                    <a href="{{ route('countries.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500">
                        Cancel
                    </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterSubregions() {
            ...
            // Optional: reset subregion selection if filtered out
