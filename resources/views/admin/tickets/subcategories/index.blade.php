                    ...
                    render: function(data) {
                        return `
                            <div class="flex space-x-2">
                                <a href="/ticket-sub-categories/${data}/edit" class="text-blue-600 hover:text-blue-800"><i class="fas fa-edit"></i></a>
                                <form action="/ticket-sub-categories/${data}" method="POST" class="inline" onsubmit="return confirm('Are you sure?')">
                                    @csrf
                                    @method('DELETE')
