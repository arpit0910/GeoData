...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900">Edit Bank</h1>
    <p class="mt-1 text-sm text-gray-600">Update bank details.</p>
</div>
    ...
    <div class="p-6 bg-white border-b border-gray-200">
        <form action="{{ route('banks.update', $bank) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $bank->name) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                @error('name')
