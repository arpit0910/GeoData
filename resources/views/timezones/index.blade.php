        ...
        <div class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Import Timezones</h3>
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">Please upload a valid Excel or CSV file to update or create records.</p>
                    </div>
                </div>
            </div>
            <form action="{{ route('timezones.import') }}" method="POST" enctype="multipart/form-data" class="mt-5 sm:mt-4">
                @csrf
                <div class="mb-4">
