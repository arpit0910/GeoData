        ...
        <form action="{{ route('regions.update', $region->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="wikiDataId" id="wikiDataId" value="{{ old('wikiDataId', $region->wikiDataId) }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" placeholder="e.g. Q2">
