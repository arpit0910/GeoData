...
@push('scripts')
    <script>
        $(document).ready(function() {
            const isinFilter = new URLSearchParams(window.location.search).get('isin') ?? '';
                ...
                columns: [
                    {
                        data: 'nav_date',
                        name: 'nav_date',
                        className: 'text-xs font-bold text-gray-700 dark:text-gray-300 whitespace-nowrap h-12 px-4',
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            return `
                            <a href="${viewUrl}" class="p-2 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 rounded-lg transition-colors" title="View Scheme">
