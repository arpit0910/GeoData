...
return [
    'jobs' => [
        ...
        [
            'title' => 'market:sync-upstox-quotes',
            'command' => 'market:sync-upstox-quotes',
            'args' => ['--batch-size' => 500],
            'description' => 'Fetches and stores all mapped Upstox quote snapshots in batches of 500.',
            'schedule' => 'Every 5 minutes on weekdays, 09:15-16:00',
            'timezone' => 'Asia/Kolkata',
            'overlap' => true,
        ],
        [
